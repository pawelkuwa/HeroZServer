...
class getItemPatternItemReward{
    ...
    public function __request($player){
        ...
        $patternValues = json_decode($player->character->current_item_pattern_values ?? '{}', true) ?? [];
        $currValue = $patternValues[$identifier] ?? null;
        if($currValue == null || $currValue['value'] < $value)
