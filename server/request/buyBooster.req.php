...
class buyBooster{
    ...
    public function __request($player){
		...
		$player->incrementGoalStat('booster_used');
		$boosterGoalKeys = [1 => 'mission_boosters_bought', 2 => 'stats_boosters_bought', 3 => 'work_boosters_bought'];
		if(isset($boosterGoalKeys[$booster['type']]))
		    $player->incrementGoalStat($boosterGoalKeys[$booster['type']]);
