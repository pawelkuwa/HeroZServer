...
return [
        ...
        'site'=>[
            ...
            //'resource_cdn'=>    'http://hz-static.akamaized.net/',
            'public_url'=>      'http://localhost/',
            'socket_url'=>      'http://localhost:9999',
            'request_url'=>     'http://localhost/server/request.php',
            //SWF's
            'swf_preloader'=>   'http://localhost/swf/preloader.swf',
            'swf_main'=>        'http://localhost/swf/main.swf?v=3',
            'swf_character'=>   'http://localhost/swf/character.swf',
            'swf_ui'=>          'http://localhost/swf/ui.swf',
            'swf_install'=>     'http://localhost/swf/expressInstall.swf',
            //Server
            'server_id'=>       'test',
            'server_name'=>     'HeroZ',
            'server_domain'=>   'hz.heroz.pl',
            'title'=>           'HeroZ',
            'mail'=>            'contact@hz.heroz.pl'
        ],
        "email"=>[
            // Driver: 'smtp' for real mail, 'mail' for PHP mail()
            'driver'            => 'smtp',
            // SMTP settings (defaults for MailPit local testing)
            'smtp_host'         => 'localhost',
            'smtp_port'         => 1025,
            'smtp_encryption'   => '',
            'smtp_username'     => '',
            ...
            'smtp_auth'         => false,
            // Sender info
            'from_email'        => 'noreply@heroz.local',
            'from_name'         => 'HeroZero Server',
            // Queue settings
            'queue_batch_size'  => 20,
            ...
            'reset_url'         => 'http://localhost/pages/reset-password.php',
            // Unsubscribe secret (HMAC-signed links)
            'unsubscribe_secret'=> 'hZ_s3cR3t_k3y_ch4ng3_m3',
            // Notification toggles
            'notify_welcome'       => true,
            'notify_ban'           => true,
            'notify_unban'         => true,
            'notify_guild_invite'  => true,
            'notify_message'       => true,
            'notify_duel_result'   => false,
        ],
        "server"=>[
            'flash_ver'=>       'flash_123',
        ],
        "constants"=>[
            ...
            //
			"slotmachine_event_start"=>"2024-01-01 00:00:00",
			"slotmachine_event_end"=>"2030-12-31 23:59:59",
			//
            ...
            //Payment
            "payment_price_overwrite"=>(object)[],
            //
